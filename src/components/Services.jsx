      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-homebear-dark mb-4">
            Our <span className="text-homebear-green-brand">Services</span>
          </h2>
        ...
        >
          <div className="relative overflow-hidden rounded-2xl p-6 md:p-8 bg-gradient-to-br from-homebear-beige to-white border border-homebear-green-brand/10 shadow-lg hover:shadow-2xl transition-all duration-300 group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-homebear-green-brand/5 rounded-full -translate-y-32 translate-x-32"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-homebear-green-brand/5 rounded-full translate-y-24 -translate-x-24"></div>
            
            <div className="relative z-10 flex flex-col md:flex-row gap-6 md:gap-8 items-start md:text-left text-center">
              {/* Icon Section */}
              <div className="mx-auto md:mx-0">
                <div className="w-16 h-16 bg-homebear-green-brand rounded-2xl flex items-center justify-center transition-transform group-hover:rotate-3 group-hover:scale-110">
              ...
              <div className="flex-1">
                <h3 className="text-xl md:text-2xl font-bold text-homebear-dark mb-4">
                  And so much more...
                </h3>
